...
from utils.login_helpers import login, get_error_message
...
def test_invalid_password_login(driver):
    ...
    assert "Username and password do not match" in get_error_message(driver)
...
def test_locked_out_user_login(driver):
    ...
    assert "Epic sadface: Username and password do not match any user in this service" in get_error_message(driver)
